...
redbird = pygame.image.load(
    "resources/angry_bird/red-bird3.png").convert_alpha()
background2 = pygame.image.load(
    "resources/angry_bird/background3.png").convert_alpha()
sling_image = pygame.image.load(
    "resources/angry_bird/sling-3.png").convert_alpha()
full_sprite = pygame.image.load(
    "resources/angry_bird/full-sprite.png").convert_alpha()
rect = pygame.Rect(181, 1050, 50, 50)
cropped = full_sprite.subsurface(rect).copy()
pig_image = pygame.transform.scale(cropped, (30, 30))
buttons = pygame.image.load(
    "resources/angry_bird/selected-buttons.png").convert_alpha()
pig_happy = pygame.image.load(
    "resources/angry_bird/pig_failed.png").convert_alpha()
stars = pygame.image.load(
    "resources/angry_bird/stars-edited.png").convert_alpha()
